(function(){
    ...
    var firstNames = ['Ana','João','Maria','Pedro','Camila','Carlos','Juliana','Rafael','Sofia','Bruno','Isabella','Lucas','Fernanda','Daniel','Mariana','Gabriel','Beatriz','Matheus','Larissa','André'];
    var locations = ['São Paulo','Rio de Janeiro','Belo Horizonte','Salvador','Brasília','Curitiba','Fortaleza','Recife','Porto Alegre','Manaus','Campinas','Florianópolis','Vitória','Santos','Goiânia','Natal'];
    var actions = ['fez upgrade para Multi-Dispositivo','expandiu para 3 dispositivos','ativou licença multi-dispositivo','habilitou monitoramento multi-alvo'];
