(function(){
    ...
    var firstNames = [
        ...
        'Aline', 'Gustavo', 'Cristina', 'Diego', 'Helena', 'Fábio', 'Graça'
    ];
    ...
    var locations = [
        ...
        'Natal', 'Campo Grande', 'Joinville', 'Uberlândia', 'Maceió', 'Niterói'
    ];
    
    var actions = [
        'ativou Análise de Comportamento IA',
        'desbloqueou detecção de padrões',
        'ativou rastreamento de comportamento IA',
