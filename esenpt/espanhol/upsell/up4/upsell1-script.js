(function(){
    ...
    var firstNames = [
        ...
        'Patricia', 'Roberto', 'Carmen', 'Sergio', 'Rosa', 'Eduardo', 'Claudia'
    ];
    
    var locations = [
        'Ciudad de México', 'Buenos Aires', 'Lima', 'Bogotá', 'Santiago', 'Madrid',
        'Barcelona', 'Medellín', 'Guadalajara', 'Quito', 'Caracas', 'Montevideo',
        'San José', 'Panamá', 'Santo Domingo', 'La Habana', 'Asunción', 'Córdoba'
    ];
    
    var actions = [
        'activó el Manto Invisible',
        'habilitó protección sigilo',
        'activó Modo Fantasma',
        'actualizó a monitoreo indetectable'
    ];
