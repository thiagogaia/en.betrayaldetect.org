(function() {
    ...
    var LOGS = [
        ...
        'Analizando indicadores de protección del teléfono...',
    ...
    var SIGNAL_MAP = {
        2: { a: 'Motivo legítimo: sospecha bien fundamentada que requiere investigación', b: 'Dudas iniciales que requieren aclaración' },
        3: { a: 'Preparación emocional confirmada para recibir información sensible', b: 'Preparación parcial — se recomienda monitoreo' },
        4: { a: 'Exposición prolongada al estrés emocional — caso prioritario', b: 'Impacto reciente pero creciente en la salud mental' },
        5: { a: 'Compromiso total con la confidencialidad y uso responsable confirmado', b: 'Compromiso parcial de confidencialidad' },
        6: { a: 'Aceptación completa de términos y responsabilidades', b: 'Aceptación con reservas — perfil cauteloso' }
    };
    ...
    var LEVELS = {
        high: {
            ...
            color: '#22c55e',
            headline: 'Verificación completa. Has sido aprobado/a para acceso inmediato.',
            diag: 'Tus respuestas demuestran <strong>necesidad genuina y madurez emocional</strong> para usar esta herramienta. Tu perfil cumple todos los criterios de seguridad. <strong>Acceso concedido sin restricciones</strong> — procede mientras tu lugar está reservado.',
            stat: '97%'
        },
        moderate: {
            label: 'ACCESO APROBADO',
            color: '#f59e0b',
            headline: 'Verificación completa. Tu acceso ha sido concedido.',
            diag: 'Tu perfil cumple los <strong>criterios mínimos de seguridad</strong>. Aunque algunas respuestas indican dudas, identificamos una necesidad genuina. <strong>Tu acceso ha sido aprobado</strong> — pero es limitado y puede expirar en cualquier momento.',
            stat: '83%'
        },
        low: {
            label: 'ACCESO CONDICIONAL',
            color: '#f59e0b',
            headline: 'Verificación completa. Acceso concedido con restricciones.',
            diag: 'Aunque tus respuestas indican menor urgencia, el hecho de haber llegado hasta aquí demuestra una <strong>necesidad que no puede ignorarse</strong>. Tu acceso ha sido concedido condicionalmente — <strong>actúa ahora antes de que expire</strong>.',
            stat: '64%'
        }
    };
    ...
    function personalizeGreeting() {
        ...
        if (first) {
            ...
            el.innerHTML = 'Oye, necesitamos verificar tu acceso.';
        }
        el.style.display = '';
    }
    ...
    function showProgress(q) {
        ...
        document.getElementById('topbarLabel').textContent = (q - 1) + ' de ' + ACTIVE;
    }
    ...
    var __QUIZ_SCORE_V9_COPY = /* QUIZ_SCORE_V9 */ { high: ['URGENTE: Desbloquea la investigación completa', 'Puntuación superior a 75 — patrones de alta sospecha detectados'], moderate: ['Obtén claridad ahora — inicia la verificación', 'Investiga las señales y elimina la duda'], low: ['Confirma que todo está bien — verifica ahora', 'Verificación anónima y silenciosa'] };
    function showResult() {
