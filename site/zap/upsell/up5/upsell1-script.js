(function(){
    ...
    var actions = [
        'activated Live Room access',
        'enabled remote camera',
        'started live microphone feed',
        'upgraded to real-time surveillance'
    ];
    ...
    function createActivityItem(isNew) {
        ...
        item.innerHTML = '<span class="activity-icon">🎙️</span> <strong>' + name + '</strong> from ' + location + ' ' + action + ' <span class="activity-time">' + time + '</span>';
        return item;
    }
